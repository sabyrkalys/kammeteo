...
$opt_name = 'kammeteo';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Глобальные настройки темы', 'kammeteo' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Глобальные настройки темы', 'kammeteo' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//docs.redux.io/',
	'title' => __( 'Documentation', 'kammeteo' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'kammeteo' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-extensions',
	'href'  => 'redux.io/extensions',
	'title' => __( 'Extensions', 'kammeteo' ),
);
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'kammeteo' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'kammeteo' ) . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'kammeteo' ) . '</p>';
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'kammeteo' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'kammeteo' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'kammeteo' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'kammeteo' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'kammeteo' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Шапка сайта', 'kammeteo' ),
		'id'               => 'header-site',
		'desc'             => esc_html__( 'These are really basic fields!', 'kammeteo' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Подвал сайта', 'kammeteo' ),
		'id'               => 'footer-site',
		'desc'             => esc_html__( 'These are really basic fields!', 'kammeteo' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-edit',
...
Redux::setSection( $opt_name, array(
 'title'            => __( 'Социальные сети', 'kammeteo' ),
 //'desc'             => __( 'Type here social links', 'kammeteo' ),
 'id'               => 'social_links',
 'subsection'       => true,
 'customizer_width' => '700px',
 'fields'           => array(
     ...
     array(
         'id'       => 'inst',
         'type'     => 'text',
         'title'    => __( 'Cылка на инстаграм', 'kammeteo' ),
         'desc'     => __( 'Укажите ссылку на инстаграм', 'kammeteo' ),
         'default'  => '',
     ),
     array(
      'id'       => 'vk',
      'type'     => 'text',
      'title'    => __( 'Cылка на vk', 'kammeteo' ),
      'desc'     => __( 'Укажите ссылку на vk', 'kammeteo' ),
      'default'  => '',
  ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'      => esc_html__( 'Данные организации', 'kammeteo' ),
		'id'         => 'Data-org',
		//'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'kammeteo' ) . '<a href="//docs.redux.io/core/fields/media/" target="_blank">docs.redux.io/core/fields/media/</a>',
		'subsection' => true,
		'fields'     => array(
			array(
				'id'           => 'footer-adress',
				'type'         => 'text',
				'title'        => esc_html__( 'Адрес организации', 'kammeteo' ),
				'desc'         => esc_html__( 'Укажи адрес', 'kammeteo' )
			),
   array(
				'id'           => 'footer-contact-url',
				'type'         => 'text',
    'url'          => true,
				'title'        => esc_html__( 'Cсылка на телефон организации', 'kammeteo' ),
				'desc'         => esc_html__( 'Укажи ссылку', 'kammeteo' )
			),
   array(
				'id'           => 'footer-contact-1',
				'type'         => 'text',
    'url'          => true,
				'title'        => esc_html__( 'Телефон организации', 'kammeteo' ),
				'desc'         => esc_html__( 'Укажи телефон', 'kammeteo' )
			),
   array(
				'id'           => 'footer-contact-fax',
				'type'         => 'text',
    'url'          => true,
				'title'        => esc_html__( 'Факс организации', 'kammeteo' ),
				'desc'         => esc_html__( 'Укажи телефон факса', 'kammeteo' )
			),
   array(
				'id'           => 'footer-email-url',
				'type'         => 'text',
    'url'          => true,
				'title'        => esc_html__( 'Ссылка на E-mail', 'kammeteo' ),
				'desc'         => esc_html__( 'укажи E-mail', 'kammeteo' )
			),
   array(
				'id'           => 'footer-email',
				'type'         => 'text',
    'url'          => true,
				'title'        => esc_html__( 'E-mail организации', 'kammeteo' ),
				'desc'         => esc_html__( 'Укажи E-mail', 'kammeteo' )
			),
		),
	)
...
/*Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Editors', 'kammeteo' ),
		'id'               => 'editor',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Color Selection', 'kammeteo' ),
		'id'    => 'color',
		'icon'  => 'el el-brush',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Design Fields', 'kammeteo' ),
		'id'    => 'design',
		'icon'  => 'el el-wrench',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Media Uploads', 'kammeteo' ),
		'id'    => 'media',
		'icon'  => 'el el-picture',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Presentation Fields', 'kammeteo' ),
		'id'    => 'presentation',
		'icon'  => 'el el-screen',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Switch / Button Set', 'kammeteo' ),
		'id'    => 'switch_buttonset',
		'icon'  => 'el el-cogs',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Select Fields', 'kammeteo' ),
		'id'    => 'select',
		'icon'  => 'el el-list-alt',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Slider / Spinner', 'kammeteo' ),
		'id'    => 'slider_spinner',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Additional Types', 'kammeteo' ),
		'id'    => 'additional',
		'icon'  => 'el el-magic',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Advanced Features', 'kammeteo' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Disabling', 'kammeteo' ),
		'icon'  => 'el el-lock',
	)
);
...
if ( class_exists( 'Redux_Pro' ) ) {
	Redux::set_section(
		$opt_name,
		array(
			'title' => esc_html__( 'Redux Pro Fields', 'kammeteo' ),
			'id'    => 'redux-pro-fields',
			'icon'  => 'el el-redux',
			'class' => 'pro_highlight',
			'desc'  => esc_html__( 'For full documentation on this field, visit: ', 'kammeteo' ) . '<a href="//docs.redux.io/premium/" target="_blank">docs.redux.io/premium/</a>',
		)
	);
...
if ( file_exists( $dir . '/../README.md' ) ) {
	$section = array(
		'icon'   => 'el el-list-alt',
		'title'  => esc_html__( 'Documentation', 'kammeteo' ),
		'fields' => array(
			array(
...
Redux::set_section(
	...
	array(
		'icon'            => 'el el-list-alt',
		'title'           => esc_html__( 'Customizer Only', 'kammeteo' ),
		'desc'            => '<p class="description">' . esc_html__( 'This Section should be visible only in Customizer', 'kammeteo' ) . '</p>',
		'customizer_only' => true,
		'fields'          => array(
			array(
				'id'              => 'opt-customizer-only',
				'type'            => 'select',
				'title'           => esc_html__( 'Customizer Only Option', 'kammeteo' ),
				'subtitle'        => esc_html__( 'The subtitle is NOT visible in customizer', 'kammeteo' ),
				'desc'            => esc_html__( 'The field desc is NOT visible in customizer.', 'kammeteo' ),
				'customizer_only' => true,
				'options'         => array(
					'1' => esc_html__( 'Opt 1', 'kammeteo' ),
					'2' => esc_html__( 'Opt 2', 'kammeteo' ),
					'3' => esc_html__( 'Opt 3', 'kammeteo' ),
				),
				'default'         => '2',
			),
		),
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( $sections ) {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', 'kammeteo' ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'kammeteo' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( $defaults ) {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'kammeteo' );
