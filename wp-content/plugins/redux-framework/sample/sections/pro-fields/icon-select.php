...
Redux::setSection(
	$opt_name,
	array(
		'title'      => esc_html__( 'Icon Select', 'kammeteo' ),
		'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'kammeteo' ) . '<a href="//docs.reduxframework.com/extensions/icon-select/" target="_blank">docs.reduxframework.com/extensions/icon-select/</a>',
		'subsection' => true,
		'fields'     => array(
			array(
				...
				'type'             => 'icon_select',
				'title'            => esc_html__( 'Icon Select', 'kammeteo' ),
				'subtitle'         => esc_html__( 'Select an icon.', 'kammeteo' ),
				'default'          => '',
