...
Redux::set_section(
	$opt_name,
	array(
		'title'      => esc_html__( 'Image Select', 'kammeteo' ),
		'id'         => 'select-image_select',
		'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'kammeteo' ) . '<a href="//docs.redux.io/core/fields/image-select/" target="_blank">docs.redux.io/core/fields/image-select/</a>',
		'subsection' => true,
		'fields'     => array(
			array(
				'id'       => 'opt-image-select-layout',
				'type'     => 'image_select',
				'title'    => esc_html__( 'Images Option for Layout', 'kammeteo' ),
				'subtitle' => esc_html__( 'No validation can be done on this field type', 'kammeteo' ),
				'desc'     => esc_html__( 'This uses some of the built in images, you can use them for layout options.', 'kammeteo' ),
			...
			array(
				...
				'type'     => 'image_select',
				'tiles'    => true,
				'title'    => esc_html__( 'Images Option (with tiles => true)', 'kammeteo' ),
				'subtitle' => esc_html__( 'Select a background pattern.', 'kammeteo' ),
				'default'  => 0,
			...
			array(
				'id'       => 'opt-image-select',
				'type'     => 'image_select',
				'title'    => esc_html__( 'Images Option', 'kammeteo' ),
				'subtitle' => esc_html__( 'No validation can be done on this field type', 'kammeteo' ),
